	...
	return (
		<span
			...
			{sessionId === "" ? (
				...
				<div className='relative flex flex-col gap-0 px-3 w-full flex-shrink-0'>
					...
					<button
						...
						/>
						<p style={navBtn === "favorite" ? { color: "white" } : { color: "#A8A29E" }}>
							Favorited
						</p>
					</button>
					<button
			...
			<div className='relative w-full h-auto px-3 text-stone-600 flex flex-col text-sm flex-shrink-0'>
				...
				<br />
				<p>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent placerat nulla at
					gravida vulputate. In elementum et mauris cursus sollicitudin. Maecenas eu dictum sem.
					Aenean blandit purus et diam auctor sollicitudin. Maecenas tempor, arcu non
					scelerisque pharetra, urna risus porta purus, ut scelerisque velit metus non ante.
				</p>
			</div>
		</span>
	)
